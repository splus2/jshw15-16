// AJAX QUERIES FOR riffsy.com
$(function() {
    $('.search-form').on('submit', function() {
        var enteredQuery = $('#entered-query').val();
        $.ajax({
            url: "http://api.riffsy.com/v1/search?tag=" + enteredQuery + "&limit=15",
            // dataType: 'jsonp',
            // method : 'GET',
...
function Student() {
    this.placeOfStudy = 'MTI';
    this.scholarship = '500$';
    this.watchMovies = function() {
        alert('This is my favourite movie!');
    }
}
